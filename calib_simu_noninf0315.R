...
seed1 = seednumber1[,1]
seed2 = seednumber2[,1]
path="/home/wangl29/Calibration/noninf_63k/"
...
#gamma_c = c(-0.2, -0.75, 0.1, 0, -0.2) #x1, d, x2, x1:d, x2:d
...
for(simu in c(simu:NSIMU)){
  ...
  Ldma.inf = jk_var(jk_out$Lambda_est);   LdmaG.inf = jk_var(jk_out$LambdaG_est)
